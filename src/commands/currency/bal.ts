...
**Total Received:** ${totalReceived.toFixed(8)} LTC / $${(totalReceived * rates.usd).toFixed(2)} USD / €${(totalReceived * rates.eur).toFixed(
      2
    )} EUR / ₹${(totalReceived * rates.inr).toFixed(2)} INR
